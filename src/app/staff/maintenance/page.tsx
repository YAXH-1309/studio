    ...
    <div className="space-y-6">
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Schedule, assign, and track the status of maintenance tasks and repair work.</CardDescription>
        </CardHeader>
        <CardContent className="text-center py-12">
          ...
          <p className="text-muted-foreground">This section will enable staff to efficiently manage all maintenance activities.</p>
        </CardContent>
      </Card>
    </div>
  );
