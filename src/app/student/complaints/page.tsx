    ...
    <div className="space-y-6">
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Submit maintenance requests, lodge complaints, or provide suggestions to the hostel staff.</CardDescription>
        </CardHeader>
        <CardContent className="text-center py-12">
          ...
          <p className="text-muted-foreground">Students will be able to submit and track their requests or complaints here.</p>
           <div className="mt-4 flex justify-center gap-4">
            <Button variant="outline"><Wrench className="mr-2 h-4 w-4" /> Request Maintenance</Button>
          </div>
        </CardContent>
      </Card>
    </div>
